...
const TodoCreateModal = ({ open, onClose, refreshParent }) => {
    const [formData, setFormData] = useState({
        title: "",
        description: "",
        due_date: dayjs(),  // Default to today’s date
        priority: "medium",
        status: "pending",
    });
    ...
    // Save New Todo
    const handleSave = () => {
        console.log("Creating new to-do:", formData);
        ...
        let config = {
            ...
            data: { ...formData,  user: localStorage.getItem("user_id")}
        };
